...
try
{
    ...
    */
    ...
    $req  = $bdd->prepare($models['list_clients']);
    $req -> execute(array($_SESSION['userID']));

    $req2  = $bdd->prepare($models['list_clients']);
                                                ...
                                                <tbody> 
                                                    <?php
                                                        if (null == ($req2->fetch())) {
                                                            ?> 
                                                            <tr class="active"> 
                                                                <td colspan="10"><p class="text-center">Aucun client</p></td> 
                                                            </tr>                                             
                                                            <?php
                                                        }
                                                        while ($ok = $req->fetch())
                                                        ...
                                                        ?> 
                                                            <tr> 
                                                                <td> 
                                                                    <?php echo htmlspecialchars($ok['client_nom']); ?> 
                                                                </td> 
                                                                <td> 
                                                                    <?php echo htmlspecialchars($ok['client_profession']); ?> 
                                                                </td> 
                                                                <td> 
                                                                    <?php echo htmlspecialchars($ok['client_adresse']); ?> 
                                                                </td> 
                                                                <td> 
                                                                    <?php echo htmlspecialchars($ok['client_contact']); ?> 
                                                                </td>
                                                            </tr>                             
                                                        <?php
                                                            }
