...
<head>
    ...
    <title>LG2A</title>
    <meta name="description" content="Application de gestion des attestations auto" />
...
<body>
    <div class="container">
        ...
        <header>
            <h1 class="softname">Logiciel de gestion des attestions autos | LG2A</h1>
        </header>
    </div>
