        ...
        <div id="wrapper"> 
            ...
            <div id="page-wrapper"> 
                <div class="container-fluid"> 
                    ...
                    <div class="row"> 
                        <div class="col-lg-12"> 
                            <h1 class="page-header"> <span>Renouveller la police</span> </h1> 
                            <!--<ol class="breadcrumb">
                            <li class="active">
                                        ...
                                        <div class="panel-body"> 
                                            <form role="form" method="POST" action="certRenewing.php"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="Entrer la date de début de la police" name="poldf" required="required"> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label class="control-label" for="exampleInputPassword1">Date de fin de la police</label>                                                     
                                                    <input type="date" class="form-control" placeholder="Entrer la date de fin de la police" name="poldt" required="required"> 
                                                </div>  
                                                <div class="form-group"> 
                                                    <label class="control-label" for="exampleInputPassword1">Montant de l'attestation</label>
                                                    <input type="number" class="form-control" name="amount" placeholder="Entrer le montant" required="required" value=""> 
                                                </div>
                                                <div class="form-group"> 
                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Entrer le genre du véhicule" name="carGenre" required="required" disabled value=<?php echo "\"".$ok['vehicule_genre']."\"" ?>> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label class="control-label" for="exampleInputPassword1">Marque du véhicule</label>
                                                    <input type="text" class="form-control" placeholder="Entrer la marque du véhicule" name="carMake" required="required" disabled value=<?php echo "\"".$ok['vehicule_marque']."\"" ?>> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label class="control-label" for="exampleInputPassword1">Immatriculation du véhicule</label>
                                                    <input type="text" class="form-control" name="imat" placeholder="Entrer le numéro d'immatriculation du véhicule" required="required" disabled value=<?php echo "\"".$ok['vehicule_mat']."\"" ?>> 
                                                </div>
                                                <div class="form-group"> 
                                                    <label class="control-label" for="exampleInputPassword1">Numéro de chassis</label>
                                                    <input type="text" class="form-control" name="chassis" placeholder="Entrer le numéro de chassis du véhicule" disabled value=<?php echo "\"".$ok['vehicule_chassis']."\"" ?>> 
                                                </div>
