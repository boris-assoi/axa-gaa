        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> <span>Création d'un producteur</span> </h1>
                            <!--<ol class="breadcrumb">
                            <li class="active">
                                ...
                                <div>
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <form role="form" method="POST" action="addComm.php">
                                                <div class="form-group">
                                                    <label class="control-label" for="formInput28">Sélectionner le POS</label>

                                                    <select id="formInput28" class="form-control" name="pos">
                                                        <?php
                                                            $request = 'SELECT pos_nom FROM pos ORDER BY pos_nom ASC';
                                                            $req = $bdd->query($request);
                                                            while ($ok = $req->fetch()) {
                                                                echo "<option class=\"text-uppercase\">" . htmlspecialchars($ok['pos_nom']) . "</option>";
                                                            }
                                                            $req->closeCursor();
                                                            ?>
                                                    </select>
