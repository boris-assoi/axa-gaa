...
try {
    ...
    $data['vol_ma']['lib'] = "vol_ma";
    $data['vol_ma']['name'] = "Vol à main armée";
    $data['vol_ma']['value'] = (string)($prime_vol_ma);
    $data['vol_ma']['option'] = "";
    ...
    $data['van']['value'] = (string)($prime_van);
    $data['van']['option'] = "";
    ...
    $data['inc']['value'] = (string)($prime_inc);
    $data['inc']['option'] = "";
